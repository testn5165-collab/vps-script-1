...
apt install -y curl wget unzip tar git build-essential net-tools socat \
    jq openssl haproxy stunnel4 dropbear certbot python3 python3-pip \
    lsof iptables uuid-runtime
